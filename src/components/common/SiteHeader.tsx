...
export function SiteHeader() {
  return (
    <div className="sticky top-6 z-50 px-12 max-lg:px-6 max-sm:top-3 max-sm:px-4">
      <header className="mx-auto flex max-w-[1280px] items-center py-3 pl-8 pr-8 text-[15px] font-bold tracking-[0.02em] rounded-pill bg-white shadow-lift max-sm:pl-5 max-sm:pr-5">
