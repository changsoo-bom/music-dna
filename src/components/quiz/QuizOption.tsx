...
export function QuizOption({ label, sub, badge, selected, onClick }: QuizOptionProps) {
  return (
    <button
      ...
      className={`group flex w-full items-center gap-5 px-7 py-5 text-left rounded-btn transition-[box-shadow,background-color,color] duration-200 max-sm:gap-4 max-sm:px-5 ${
